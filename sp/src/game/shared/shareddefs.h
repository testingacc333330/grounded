...
#define MAX_WEAPON_SLOTS		3	// hud item selection slots
#define MAX_WEAPON_POSITIONS	1	// max number of items within a slot
#define MAX_ITEM_TYPES			3	// hud item selection slots
