...
#ifdef DARKINTERVAL // extra fire functionality to save on entity counts
...
#ifdef DARKINTERVAL // moved out of fire.cpp to this header
...
public:
	...
	void	SetHeatLevel(float heat) { m_damage = heat; }
